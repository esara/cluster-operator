...
func NewDeployment(client client.Client, nfsServer *storageosv1.NFSServer, recorder record.EventRecorder, scheme *runtime.Scheme, logger logr.Logger) *Deployment {
	return &Deployment{
		client:    client,
		nfsServer: nfsServer,
		recorder:  recorder,
